          ...
          <div className="row center">
            <div className="col-md-12" align="left">
              ...
              <font face="verdana" size={3}>
                ...
                death of a girl of Tharayil family, and the parents had to bury
                her in their family property. Tharayil Mappila seriously thought
                about building a church. He shared this idea with Vayelakkombil
                Itty Mappila and Erakonni Mappila of Mevda. They approached the
                Meenachil Kartha and requested the sanction to build a church.
                The Kartha demanded the presence of four families. To satisfy
                the demand of Kartha, one of the Tharayil brothers Johannan
                built a new house at Kootumgal and started residing there. Then
                Kartha permitted them to build the church.
              </font>
              <font face="verdana" size={3}>
                <br /> <br />
                &nbsp;&nbsp;The site of the first old church is where St. Thomas
                Cathedral Church Pala is situated today. The foundation stone of
                the church was laid by the Arch Bishop Mar Johannan in July 1002
              ...
              <div align="center">
                ...
                />
                <br />
                &nbsp; Our Great Great Grand Parents (Ouseph and Thessia
                Njandupara) <br />
                <hr />
                <br />
                <br />{" "}
                ...
                />
                <br />
                &nbsp; The Njandupara Tharavadu
                <br />
                <hr />
                <br />
                <img
                  src="/images/album/thravadu_backyard.jpg"
                  alt="Ancestral Home Backyard"
                  width={700}
                />
                <br />
                ...
                <hr /> <br />
                <img
                  src="/images/album/kochi_family.jpg"
                  alt="Kochi Family"
                  width={700}
                />
                <br />
                ...
                <hr /> <br />
                <img
                  src="/images/album/get_together.jpg"
                  alt="Get-together"
                  width={700}
                />
                <br />
                &nbsp; The Kuzhiamplavans in USA
                <br />
                <hr /> <br />
                <img
                  src="/images/album/tharavadu_new.jpg"
                  alt="Ancestral Home"
                  width={700}
                />
                <br />
